  ...
  return (
    <div className="py-0">
        ...
        >
          ...
          <tbody className="">
            {qualifications.map((qualification) => (
              <tr key={qualification.id} className="border-b text-headingColor">
                <th
                  scope="row"
      ...
      <div className="my-5 text-right">
        <button
          className={`${loading && 'hidden'} w-[200px] bg-primaryColor text-white text-[16px] leading-7 rounded-lg px-4 py-2`}
          type="submit"
